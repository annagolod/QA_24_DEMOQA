...
public class CssLocators {
    ...
    public void start(){
        ...
        //*[type='email'] - более долгий способ (любой тег с таким аттрибутом

        WebElement elementCurrentAddress = driver.findElement(By.cssSelector("#currentAddress"));
        System.out.println("--> " + elementCurrentAddress.getTagName());
    ...
    public void buttons(){
        ...
        List<WebElement> elementList = driver.findElements(By.cssSelector("div[class='col-12 mt-4 col-md-6'] div[class='mt-4']>button"));
